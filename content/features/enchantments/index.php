...
<html lang="en">
  ...
  <body>
    ...
    <main>
      <div class="sub-title" style="background-image: linear-gradient(rgba(0, 0, 0, 0.1), rgba(0, 0, 0, 0.1)), url(/assets/images/enchantments-title.webp); background-position: 50% 45%;">
        <div>
