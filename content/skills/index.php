...
<html lang="en">
  <head>
    <title>SemiVanilla Minecraft Server | Skills & Abilities</title>
    <meta charset="utf-8" />
    <meta name="description" content="Skills and abilities - A semi-vanilla 1.18.1 survival Minecraft server. Java + Bedrock support! Competitive multiplayer adventure. Join Now!" />
    ...
    <meta name="keywords" content="mcmmo, skills, aurelium, treefeller, veinminer, minecraft, survival, server, bedrock, semi, vanilla, java, pvp, pve, rpg, multiplayer" />
    ...
    <main>
      ...
      <div class="content">
        <section class="center">
          <h3>Coming Soon</h3>
          <p>We're writing some great guides right now</p>
      </div>
    </main>
