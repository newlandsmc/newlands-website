...
<html lang="en">
  <head>
    <title>SemiVanilla Studios | Asthonia | Custom Mobs</title>
  ...
  <body>
    ...
    <main>
      <div class="sub-title" style="background-image: url(/assets/images/asthonia/mobs-title.webp); background-position: center;">
        <div>
          <h1>Custom Mobs</h1>
      ...
      <div class="content split-content">
        ...
        <div>
          <section>
            ...
            <img class="medium" src="/assets/images/asthonia/mobs-bat.webp" alt="Minecraft bat"></img>
          </section>
          <section>
            <h3>Mob Leader</h3>
            ...
            <img class="medium" src="/assets/images/asthonia/mobs-mob-leader.webp" alt="Minecraft Illusioner, zombie, and skeleton"></img>
          </section>
          <section>
            <h3>Angry Sludge</h3>
            <p>A giant slime. Slow, but lots of health. Also inflicts poison.</p>
            <p>The Angry Sludge can be found in swamps..</p>
            <img class="medium" src="/assets/images/asthonia/mobs-slime.webp" alt="Minecraft Slime"></img>
          </section>
        </div>
        <div>
          <section>
            ...
            <img class="medium" src="/assets/images/asthonia/mobs-skeleton-king.webp" alt="Minecraft Wither Skeleton and two skeletons"></img>
          </section>
          <section>
            ...
            <img class="medium" src="/assets/images/asthonia/mobs-wither-skeleton.webp" alt="Minecraft Wither Skeleton"></img>
          </section>
        </div>
      </div>
    </main>
