...
<html lang="en">
  <head>
    <title>SemiVanilla Studios | Asthonia | Custom Enchants</title>
  ...
  <body>
    ...
    <main>
      <div class="sub-title" style="background-image: url(/assets/images/asthonia/enchants-title.webp); background-position: center;">
        <div>
          <h1>Asthonia</h1>
          <h2>Custom Enchantments</h2>
        </div>
      </div>
      <div class="content split-content">
        ...
        <div>
          <section>
            ...
            <p>There are <strong>94</strong> custom enchants available on Asthonia. They are available for all types of weapons, armor, and tools.</p>
