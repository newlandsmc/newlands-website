...
<html lang="en">
  <head>
    <title>SemiVanilla Studios | Khavalon | Enchants</title>
  ...
  <body>
    ...
    <main>
      <div class="sub-title" style="background-image: url(/assets/images/khavalon/enchants-title.webp); background-position: center;">
        <div>
          <h1>Khavalon</h1>
