...
<html lang="en">
  ...
  <body>
    ...
    <main>
      <div class="sub-title" style="background-image: url(/assets/images/mobs-title-oil.webp); background-position: center;">
        <div>
          <h1>Custom Mobs</h1>
      ...
      <div class="content split-content">
        <div>
          <section>
            ...
            <img class="medium" src="/assets/images/mobs-vampire-bat-oil.webp" alt="Minecraft bat"></img>
          </section>
          <section>
            <h3>Mob Leader</h3>
            ...
            <img class="medium" src="/assets/images/mobs-mob-leader-oil.webp" alt="Minecraft Illusioner, zombie, and skeleton"></img>
          </section>
        </div>
        <div>
          <section>
            ...
            <img class="medium" src="/assets/images/mobs-skeleton-king-oil.webp" alt="Minecraft Wither Skeleton and two skeletons"></img>
          </section>
          <section>
            ...
            <img class="medium" src="/assets/images/mobs-skeletal-knight-oil.webp" alt="Minecraft Wither Skeleton"></img>
          </section>
        </div>
      </div>
    </main>
